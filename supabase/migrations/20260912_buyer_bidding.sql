-- ============================================================================
-- KISAN SETU — Buyer Role & Bidding System Migration
-- File: supabase/migrations/20260912_buyer_bidding.sql
-- Purpose: Adds buyer accounts, mandi-scoped bidding windows, bids table,
--          RLS policies, indexes, and atomic RPCs for the bidding workflow.
-- ============================================================================

-- ═══════════════════════════════════════════════════════════════════════════════
-- 1. EXTEND PROFILES TABLE & CHECK CONSTRAINTS
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- ── Bidding Windows table policies ──
